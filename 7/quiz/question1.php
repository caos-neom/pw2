    ...
    <div class="row d-flex justify-content-center">
        <div class="col-8">
            <form action="./question1.php" method="post">
                <div class="md-3">
                    <h1>O que Dom Pedro I gritou no dia da independência?</h1>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <label for="question1">desordem e regresso</label>
                </div>
                <div class="mb-3">
                    <input type="radio" name="question1" id="question1" value="resp3">
                    <label for="question1">eu sou imbrochavél tá ok</label>
                </div>
                <div class="mb-3">
            ...
            if(isset($_POST['question1'])){
                if(empty($_POST['question1'])){
                    echo '<div class="alert alert-warning" role="alert">Favor selecionar uma alternativa</div>';
                }
                if(!empty($_POST['question1'])){
                    if($_POST['question1'] == 'resp4'){
                        echo '<div class="alert alert-success" role="alert">Você acertou <a href="question2.php">Avancar</a></div>';
